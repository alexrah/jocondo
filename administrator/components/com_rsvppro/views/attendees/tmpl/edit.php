...
$html .='
	...
	<td class="paramlist_value"><input type="text"	name="jev_name" onchange="findUser(event,this,\'' . JURI::root() . "components/com_rsvppro/libraries/finduser.php" . '\')" onkeyup="findUser(event,this,\'' . JURI::root() . "components/com_rsvppro/libraries/finduser.php" . '\')" size="15"  />
