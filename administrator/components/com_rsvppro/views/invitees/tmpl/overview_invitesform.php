...
if ($user->id==$this->row->created_by() || JEVHelper::isAdminUser($user)){
	...
	<div id="jev_name"  style="display:none" >
		...
		<input type="text"	name="jev_name" onchange="findUser(event,this,\''.JURI::root() . "components/com_rsvppro/libraries/finduser.php".'\', \''.$client.'\')" onkeyup="findUser(event,this,\''.JURI::root() . "components/com_rsvppro/libraries/finduser.php".'\', \''.$client.'\')" size="30"  />
		</div>
	</div>
